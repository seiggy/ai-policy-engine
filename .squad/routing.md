...
|-----------|----------|----------|
| Architecture & design | McNulty | System design, API contracts, component boundaries, tech decisions |
...
| AAA policy logic | Freamon + Sydnor | Auth enforcement (backend) + APIM policy XML (infra) |
| Billing & reporting | Freamon + Kima | Backend calculations + dashboard UI |
